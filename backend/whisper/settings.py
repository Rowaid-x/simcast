...
Security-focused chat application with auto-deleting messages.
"""
import os
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://whisper:whisper@localhost:5432/whisper',
        conn_max_age=600,
    )
}
...
# Message Encryption Key (32-byte base64 encoded)
